...
Visualize the blast radius of npm supply chain attacks across the top 1,000 packages.
...
This tool seeds the top 1,000 npm packages (by downloads and dependents), fetches their dependency graphs from [deps.dev](https://deps.dev), and builds a force graph showing what happens if any one of them gets taken over.

Pick a package and you'll see:

- how many other top-1,000 packages it would reach
...
npm run seed        # top 1,000 packages -> data/top.json
